        ...
        <div class="row" style="margin: 0px; padding:0px; margin-bottom: 50px;">
            ...
            <div class="col-lg-6 col-lg-push-3" style="min-height: 500px; background-color: white;">
                ...
                if(isset($_SESSION["answer"]))
                {
                    ...
                    {
                        $answer="";
                        $res=mysqli_query($link,"select * from questions where category='$_SESSION[exam_category]' && question_no=$i")or die(mysqli_error($link)); 
                ...
                $wrong=$count-$correct;
                echo '<div class="my_class" style="margin-left: 40px; margin-top: 40px; color: blue; font-size: 23px" >';
                echo "<br>";echo "<br>";
                echo "<center>";
