...
?>
    ...
    <div class="row" style="margin: 0px; padding:0px; margin-bottom: 50px;">
        ...
        <div class="col-lg-6 col-lg-push-3" style="min-height: 500px; background-color: white;">
            ...
            <br>
            <div>  <h4>Exam Name :- <?php echo  "<font color='red'>" .$_SESSION["cat1"]. "</font>"; ?></h4></div>
            <div class="row">
                <div class="col-lg-4 col-lg-push-9">
                    <div id="current_que" style="float:left"></div>
                    <div style="float:left"><h4>Total Questions :</h4></div>
                    <div id="total_que" style="float:left; margin-left:3px; margin-top:2px "></div>
                </div>
                ...
                <div class="col-lg-10 col-lg-push-1" style="min-height: 50px">
                    ...
                    <a href="result.php" class="btn btn-success" style="margin-left: 510px">End Exam</a>
                </div>
