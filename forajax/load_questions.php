...
{
    ?>
    <h3> <a style="margin-left :285px; margin-top :20px" href="result.php ?>"> Result </a><h3>
    <?php
}
else
{
    ...
    <br>
        <table>
            <tr>
                <td style="font-weight: bold; font-size: 23px; paddinf-left: 5px" colspan="2">
                    <?php
        ...
        <table style="margin-left: 40px; margin-top: 20px; font-size: 23px">
            <tr>
                <td>  
